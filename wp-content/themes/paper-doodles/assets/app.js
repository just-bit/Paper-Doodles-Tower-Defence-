...
goblinsImg.src = ASSETS_URL + '/images/goblins.png';

const knightsImg = new Image();
knightsImg.src = ASSETS_URL + '/images/knights.png';

const caveImg = new Image();
caveImg.src = ASSETS_URL + '/images/cave.png';

const castleImg = new Image();
castleImg.src = ASSETS_URL + '/images/castle.png';

// Game config (from WordPress ACF or defaults)
const _cfg = (typeof paperDoodles !== 'undefined') ? paperDoodles : {};
const MAX_WAVE = Number(_cfg.maxWave) || 100;
const AUTO_NEXT_WAVE = Number(_cfg.autoNextWave) || 15000;

let gold = Number(_cfg.startGold) || 600;
let lives = Number(_cfg.startLives) || 15;
...
const SCALING_BOSS_HP_MULT = 2;              // Множитель HP боссов (поверх остального)
...
// Tower configs (from WordPress ACF or defaults)
const _towers = (_cfg.towers && typeof _cfg.towers === 'object') ? _cfg.towers : {};

function _tw(num, key, def) {
    const t = _towers['tower' + num];
    return (t && t[key]) ? Number(t[key]) : def;
}

// Tower 1
const TOWER1_COST = _tw(1, 'cost', 80);
const TOWER1_UPGRADE_COST = _tw(1, 'upgradeCost', 100);
const TOWER1_CELLS = _tw(1, 'cells', 1);
const TOWER1_DAMAGE_LVL_1 = _tw(1, 'damageLvl1', 20);
const TOWER1_DAMAGE_LVL_2 = _tw(1, 'damageLvl2', 30);
const TOWER1_DAMAGE_LVL_3 = _tw(1, 'damageLvl3', 40);
const TOWER1_RANGE_LVL_1 = _tw(1, 'rangeLvl1', 70);
const TOWER1_RANGE_LVL_2 = _tw(1, 'rangeLvl2', 77);
const TOWER1_RANGE_LVL_3 = _tw(1, 'rangeLvl3', 84);
const TOWER1_FIRE_RATE_LVL_1 = _tw(1, 'fireRateLvl1', 300);
const TOWER1_FIRE_RATE_LVL_2 = _tw(1, 'fireRateLvl2', 270);
const TOWER1_FIRE_RATE_LVL_3 = _tw(1, 'fireRateLvl3', 243);

// Tower 2
const TOWER2_COST = _tw(2, 'cost', 150);
const TOWER2_UPGRADE_COST = _tw(2, 'upgradeCost', 170);
const TOWER2_CELLS = _tw(2, 'cells', 2);
const TOWER2_DAMAGE_LVL_1 = _tw(2, 'damageLvl1', 25);
const TOWER2_DAMAGE_LVL_2 = _tw(2, 'damageLvl2', 38);
const TOWER2_DAMAGE_LVL_3 = _tw(2, 'damageLvl3', 50);
const TOWER2_RANGE_LVL_1 = _tw(2, 'rangeLvl1', 84);
const TOWER2_RANGE_LVL_2 = _tw(2, 'rangeLvl2', 92);
const TOWER2_RANGE_LVL_3 = _tw(2, 'rangeLvl3', 101);
const TOWER2_FIRE_RATE_LVL_1 = _tw(2, 'fireRateLvl1', 500);
const TOWER2_FIRE_RATE_LVL_2 = _tw(2, 'fireRateLvl2', 450);
const TOWER2_FIRE_RATE_LVL_3 = _tw(2, 'fireRateLvl3', 405);

// Tower 3
const TOWER3_COST = _tw(3, 'cost', 250);
const TOWER3_UPGRADE_COST = _tw(3, 'upgradeCost', 300);
const TOWER3_CELLS = _tw(3, 'cells', 3);
const TOWER3_DAMAGE_LVL_1 = _tw(3, 'damageLvl1', 30);
const TOWER3_DAMAGE_LVL_2 = _tw(3, 'damageLvl2', 45);
const TOWER3_DAMAGE_LVL_3 = _tw(3, 'damageLvl3', 60);
const TOWER3_RANGE_LVL_1 = _tw(3, 'rangeLvl1', 101);
const TOWER3_RANGE_LVL_2 = _tw(3, 'rangeLvl2', 111);
const TOWER3_RANGE_LVL_3 = _tw(3, 'rangeLvl3', 121);
const TOWER3_FIRE_RATE_LVL_1 = _tw(3, 'fireRateLvl1', 1000);
const TOWER3_FIRE_RATE_LVL_2 = _tw(3, 'fireRateLvl2', 900);
const TOWER3_FIRE_RATE_LVL_3 = _tw(3, 'fireRateLvl3', 810);
